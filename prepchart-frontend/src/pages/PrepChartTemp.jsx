...
const pictures = dragList.map(picture => <Picture Description={picture.Description} InventoryItemID={picture.InventoryItemID}  ThawTime={picture.ThawTime} />)
const Cell = ({ value }) => {
...
function Dragdrop() {
    ...
    const addImage = (InventoryItemID) => {
        const droppedPictures = dragList.filter(picture => InventoryItemID === picture.InventoryItemID)
   ...
   const addImagen = (InventoryItemID) => {
    ...
    const Today = board.map(picture => <Picture Description={picture.Description} ThawTime={picture.ThawTime} />)

    const Tomorrow = boardt.map(picture => <Picture Description={picture.Description} ThawTime={picture.ThawTime} />)

    
    const NextDay = boardn.map(picture => <Picture Description={picture.Description} ThawTime={picture.ThawTime} />)
