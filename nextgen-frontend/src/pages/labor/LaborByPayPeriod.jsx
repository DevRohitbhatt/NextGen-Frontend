          ...
          if (subrow.getCanExpand()) {
            return (
              ...
              subrow.subRows.reduce(
                (subAcc, subSubrow) => subAcc + subSubrow.original[accessor],
                0
              )
            );
          } else {
      ...
      <header className="optionsBar flex justify-between items-center mb-2 rounded-2xl p-4 shadow-[0px_3px_20px_-10px_rgba(0,_0,_0,_0.5)]">
        <div className="flex items-center">
          ...
          <div className="run-button" onClick={fetchLaborByPayPeriod}>
            <div className="py-3 ml-3 text-[16px] font-bold text-center capitalize border-2 border-solid cursor-pointer px-14 hover:border-primary hover:text-white hover:bg-primary text-nowrap rounded-3xl mt-7">
              Run
            </div>
          </div>
        </div>
