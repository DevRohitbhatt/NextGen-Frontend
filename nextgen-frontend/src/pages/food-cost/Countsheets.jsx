...
const Countsheets = () => {
    ...
    try {
      ...
      const newData = result.data
        ...
        .map((data) => ({
          ...data,
          companyId: companyID,
          unitName: unitsAndAreas.units.find(
      ...
      setIsError(true);
      setErrorMessage(
        "There was an issue loading your countsheets, please try again later."
      );
  ...
  const handleCountType = (option) => {
    ...
    if (option === "All") {
      ...
      setFilteredCountsheetData(
        countsheetData.filter((data) => data.countType === viewMap[option])
      );
    }
  };
