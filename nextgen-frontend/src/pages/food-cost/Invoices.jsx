  ...
  const Table =
    ...
    (isBrowseInvoicesClicked ? (
      ...
      <div className="mx-auto mt-5 text-lg w-fit">
        Enter invoice reference or total for searching
      </div>
    ) : searchKey.length < 3 ? (
      <div className="mx-auto mt-5 text-lg w-fit">
          ...
          <div className="w-full max-w-5xl p-6 overflow-auto bg-white rounded-lg shadow-lg">
            <div className="my-4">
              <div className="text-sm">
                <span className="font-semibold">Unit:</span> 2290 Walmart
                Missouri City
              ...
              <div className="mt-1 text-sm">
                ...
                <span className="mx-2 font-semibold">Last Edited By:</span> Data
                Import
              </div>
            </div>
