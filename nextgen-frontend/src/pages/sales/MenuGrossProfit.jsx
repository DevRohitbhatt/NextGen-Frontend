			...
			body: [
				{
					...
					data: {
						...
						rows: menuGrossProfitData.map((row) => [
							{ value: row.category, cellType: 'string', columnName: 'Category' },
							{ value: row.itemID, cellType: 'string', columnName: 'Item ID' },
							{ value: row.itemName, cellType: 'string', columnName: 'Item Name' },
							{ value: row.itemPrice, cellType: 'string', columnName: 'Item Price' },
							{ value: row.recipeCost, cellType: 'string', columnName: 'Recipe Cost' },
							{ value: row.costper, cellType: 'string', columnName: 'Cost %' },
							{ value: row.quantitySold, cellType: 'string', columnName: 'Quantity Sold' },
							{
								value: row.itemSales === 0 ? '0 ' : row.itemSales,
								cellType: 'string',
								columnName: 'Item Sales',
							},
							{ value: row.grossProfit, cellType: 'string', columnName: 'Gross Profit' },
							{ value: row.grossProfitper, cellType: 'string', columnName: 'Gross Profit %' },
						]),
					},
				},
			],
