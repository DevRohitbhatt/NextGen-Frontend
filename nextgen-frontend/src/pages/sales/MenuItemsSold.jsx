		...
		try {
			...
			const getData = {
				...
				urlParams: {
					...
					fromDate: selectedFromDate.toLocaleDateString('en-CA'),
					toDate: selectedToDate.toLocaleDateString('en-CA'),
					options: view === 0 ? 'GroupSummary' : view === 1 ? 'GroupByUnit' : 'GroupByUnit',
			...
			const newData = result.data.map((item) => ({
				...
				menuItemSoldModifierModels: item.menuItemSoldModifierModels.map((modifier) => ({
				...
				menuItemSoldModifierUnitReportModels: item.menuItemSoldModifierUnitReportModels.map((unit) => ({
					unitId: unit.unitId,
					unitName: unit.unitName,
					menuItemSoldModifierModels: unit.menuItemSoldModifierModels.map((modifier) => ({
						unitId: modifier.unitId,
						unitName: modifier.unitName,
						itemId: modifier.itemId,
						modItemID: modifier.modItemID,
