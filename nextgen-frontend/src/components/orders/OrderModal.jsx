...
import { VendorSelector, VendorModal, UnitSelector, UnitModal, Tooltip, DateRangePicker } from '../index';

const toolTipText =
	'The Order Span Date typically starts with the next order delivery date and extened through either the day before or day of the follwing delivery date';
						...
						<PopupContainer>
							<LeftSection>
								...
								<Rows>
									...
									<DateRangePicker selectedDates={selectedDates} onDateChange={setSelectedDates} />
								</Rows>
							</LeftSection>
						</PopupContainer>
					</ModalBody>
