		...
		<>
			{!fromDate || (isDateRange && !toDate) ? ( // Check if dates are undefined
				<div className={`flex flex-col justify-center m-1 rounded-3xl date-selector ${extraClass}`}>
					...
					<div className='px-6 py-2 text-center capitalize border-2 border-solid cursor-pointer text-nowrap rounded-3xl text-[14px]'>
						Loading...
					</div>
				</div>
			) : !isDateRange ? (
				...
				>
					{isEditable ? (
						...
						<h3 className='mb-1 ml-2 text-[16px] font-semibold text-nowrap'>Date Range</h3>
					)}
					<div
