        ...
        <table className="table min-w-full table-auto ">
          <thead className="">
            <tr className="shadow-[0_-1px_0_var(--tw-primary)_inset]">
              <th className="px-2 py-2 text-sm text-left lg:px-4 lg:py-2 text-nowrap">
                Group Name
              </th>
              <th className="px-2 py-2 text-sm text-left lg:px-4 lg:py-2 text-nowrap">
                Cook Interval
    ...
    <div className="gap-[20px] flex justify-between mx-auto p-4 h-[100%] relative flex-col">
      ...
      >
        <table className="min-w-full table-auto ">
          <thead className="">
            <tr className="shadow-[0_-1px_0_var(--tw-primary)_inset]">
              <th className="px-4 py-2 text-sm text-left text-nowrap">
                Group Name
              </th>
              <th className="px-4 py-2 text-sm text-left text-nowrap">
                Cook Interval
              ...
              <th className="px-2 py-2 text-sm text-left text-nowrap">
                Labor Fixed
              </th>
              <th className="px-4 py-2 text-sm text-left text-nowrap">
                Labor Var
