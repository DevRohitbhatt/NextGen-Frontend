				...
				<table className='table min-w-full table-auto '>
					<thead className=''>
						<tr className='shadow-[0_-1px_0_var(--tw-primary)_inset]'>
							<th className='px-2 py-2 text-sm text-left lg:px-4 lg:py-2 text-nowrap'>Group Name</th>
							<th className='px-2 py-2 text-sm text-left lg:px-4 lg:py-2 text-nowrap'>Cook Interval</th>
							<th className='px-2 py-2 text-sm text-left lg:px-4 lg:py-2 text-nowrap'>Cook time</th>
							<th className='px-2 py-2 text-sm text-left lg:px-4 lg:py-2 text-nowrap'>Hold Time</th>
							<th className='px-2 py-2 text-sm text-left lg:px-4 lg:py-2 text-nowrap'>Safety Factor</th>
							<th className='px-2 py-2 text-sm text-left lg:px-4 lg:py-2 text-nowrap'>Project Ahead</th>
							<th className='px-2 py-2 text-sm text-left lg:px-4 lg:py-2 text-nowrap'>Labor Fixed</th>
							<th className='px-2 py-2 text-sm text-left lg:px-4 lg:py-2 text-nowrap'>Labor Var</th>
							<th className='px-2 py-2 text-sm text-left lg:px-4 lg:py-2 text-nowrap'>Source Type</th>
							<th className='px-2 py-2 text-sm text-left lg:px-4 lg:py-2 text-nowrap'>UOM</th>
							<th className='px-2 py-2 text-sm text-left lg:px-4 lg:py-2 text-nowrap'>Mix Multiplier</th>
						</tr>
					</thead>
					<tbody>
						<tr className=''>
							<td className='px-2 py-2 '>
								<input
									...
									className={`bg-gray-200 p-2 w-full rounded-full   ${
										invalidFields.cookItemName ? 'border border-red-500' : 'border-none '
									}`}
									onChange={(e) => {
							...
							<td className='px-2 py-2 '>
								<input
									...
									className={`bg-gray-200 p-2 w-[105px] rounded-full   ${
										invalidFields.safetyFactor ? 'border border-red-500' : 'border-none'
									}`}
									onChange={(e) => {
								...
								>
									{projectAheadOptions.map((projAhed) => (
										<option
											...
											value={projAhed.name}
										>
											<div className='w-[90px] bg-[#f9f9f9] text-sm m-5'>{projAhed.name}</div>
										</option>
									))}
								</select>
							</td>
							...
							<td className='px-2 py-2 '>
								<input
									...
									className={`bg-gray-200 p-2 w-[90px] rounded-full  ${
										invalidFields.unitOfMeasure ? 'border border-red-500' : 'border-none'
									} `}
									onChange={(e) => {
							...
							<td className='px-2 py-2'>
								<input
									...
									className={`bg-gray-200 p-2 w-[115px] rounded-full  ${
										invalidFields.mixMultiplier ? 'border-red-500 border' : 'border-none'
									}`}
									onChange={(e) => {
										const inputValue = e.target.value.replace(/%/g, ''); // Remove '%' from the input
										if (!isNaN(inputValue)) {
		...
		<div className='gap-[20px] flex justify-between mx-auto p-4 h-[100%] relative flex-col'>
			<div className=' xl:flex space-y-3 xl:space-y-0 py-3 px-4 rounded-[30px] shadow-[0_0px_35px_-10px_rgba(0,0,0,0.3)] justify-between items-center tableHOC overflow-x-auto overflow-y-visible'>
				<table className='min-w-full table-auto '>
					<thead className=''>
						<tr className='shadow-[0_-1px_0_var(--tw-primary)_inset]'>
							<th className='px-4 py-2 text-sm text-left text-nowrap'>Group Name</th>
							<th className='px-4 py-2 text-sm text-left text-nowrap'>Cook Interval</th>
							<th className='px-4 py-2 text-sm text-left text-nowrap'>Cook time</th>
							<th className='px-4 py-2 text-sm text-left text-nowrap'>Hold Time</th>
							<th className='px-4 py-2 text-sm text-left text-nowrap'>Safety Factor</th>
							<th className='px-4 py-2 text-sm text-left text-nowrap'>Project Ahead</th>
							<th className='px-2 py-2 text-sm text-left text-nowrap'>Labor Fixed</th>
							<th className='px-4 py-2 text-sm text-left text-nowrap'>Labor Var</th>
							<th className='px-4 py-2 text-sm text-left text-nowrap'>Source Type</th>
							<th className='px-4 py-2 text-sm text-left text-nowrap'>UOM</th>
							<th className='px-4 py-2 text-sm text-left text-nowrap'>Mix Multiplier</th>
						</tr>
					</thead>
					<tbody>
						<tr className=''>
							<td className='px-2 py-2 '>
								<input
									...
									className='w-full p-2 bg-gray-200 border-none rounded-full '
									onChange={(e) => {
										onChangeHeaderValues(e, 'cookItemName');
									}}
								/>
