...
export default function SetOrderLimitsModal({
	...
	const [inventoryItemOrderLimits, setInventoryItemOrderLimits] = useState(itemOrderQuantities);
	...
	const handleSubmit = async () => {
		let updatedOrderLimits = orderLimits.filter(
			(orderLimit) => orderLimit.qsrInventoryItemID !== inventoryItemData.qsrInventoryItemID
		);
		...
		try {
			const postData = {
				url: 'updateInventoryItemOrderLimits',
				urlParams: {
					companyID: companyAndUnitData.companyID,
					unitID: companyAndUnitData.unitID,
					qsrInventoryItemID: inventoryItemData.qsrInventoryItemID,
					minOrderQuantity: inventoryItemOrderLimits.minOrderQuantity,
					maxOrderQuantity: inventoryItemOrderLimits.maxOrderQuantity,
				},
	...
	const handleDelete = async () => {
		...
		try {
			const deleteData = {
				url: 'deleteInventoryItemOrderLimits',
				urlParams: {
					companyID: companyAndUnitData.companyID,
					unitID: companyAndUnitData.unitID,
					qsrInventoryItemID: inventoryItemData.qsrInventoryItemID,
