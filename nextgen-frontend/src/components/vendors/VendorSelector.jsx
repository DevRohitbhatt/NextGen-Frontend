  ...
  return (
    <>
      {formVersion ? (
        ...
        >
          <div
            className={`whitespace-nowrap text-[18px] rounded-md border-2 px-8 py-2 text-center ${
              isInvalid
                ? 'border-red-500'
                : 'border-gray-200'
        ...
        >
          <div className="mb-1 ml-2 text-xl font-semibold text-nowrap text-[18px]">
            {isEditable ? 'Select Vendor(s)' : 'Vendor'}
          </div>
          <div
						className={`px-6 py-3 text-center capitalize border-2 border-solid  text-nowrap rounded-3xl text-[16px] ${
