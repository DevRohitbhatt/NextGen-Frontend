...
const TableHOC = (columns, data, isPaginated = true) => {
	...
	return (
		<div className='rounded-2xl border-[1px] shadow-[0_5px_35px_-5px_rgba(0,0,0,0.3)] mt-10 p-3'>
			...
			{/* table */}
			<div className=' pr-1 max-h-[60vh] overflow-auto scrollbar scrollbar-thumb-rounded-3xl scrollbar-thumb-[var(--tw-primary)] scrollbar-track-[var(--tw-secondary)]'>
						...
						{table.getRowModel().rows.map((row) => (
							<>
								{row.getCanExpand() && (
									...
									>
										<td
											className='p-2 border-b border-solid border-[var(--tw-secondary)]'
