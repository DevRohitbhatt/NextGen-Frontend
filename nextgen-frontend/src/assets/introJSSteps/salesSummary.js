export default function salesSummary() {
	return [
		{
			intro:
				'<center>Welcome to QSROnline’s Sales Summary Report tool! Let us show you around.' +
		...
		},
		{
			...
			intro: '-Select the date, or date range, you wish to display Sales Summary Report',
		},
		{
			element: '.run-button',
		...
		},
		{
			...
			intro: 'You can export the Sales Summary Report to either .CSV, .XLSX or .PDF format. The ? icon will launch this guided tour.',
		},
		{
			element: '.all',
			intro:
		...
		},
        {
			...
			intro:
				'-All information is displayed for Category Sales' +
				'<br><br> -Tooltips will explain the column element in more detail,  ' +
				'just hover your cursor over the tooltip.<br><br> -The columns on this page are sortable for convenience. Just click on the column header to sort.',
		},
        {
			element: '.Payments',
			intro:
				'-All information is displayed for Payments.' +
				'<br><br> -Tooltips will explain the column element in more detail,  ' +
				'just hover your cursor over the tooltip.<br><br> -The columns on this page are sortable for convenience. Just click on the column header to sort.',
		},
        {
			element: '.Discounts',
			intro:
				'-All information is displayed for Discounts.' +
				'<br><br> -Tooltips will explain the column element in more detail,  ' +
				'just hover your cursor over the tooltip.<br><br> -The columns on this page are sortable for convenience. Just click on the column header to sort.',
		},
	];
