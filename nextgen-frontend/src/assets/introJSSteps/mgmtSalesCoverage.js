export default function mgmtSalesCoverage() {
	return [
		{
			intro:
				'<center>Welcome to QSROnline’s Management Sales Coverage Report tool! Let us show you around.' +
		...
		},
		{
			...
			intro: '-Select the date, or date range, you wish to display Management Sales Coverage Report',
		},
		{
			element: '.jobType-selector',
			intro: '-Select the Job Type for which you wish to see the Management Sales Coverage report.',
		},
		{
			element: '.run-button',
		...
		},
		{
			...
			intro: 'You can export the Management Sales Coverage Report to either .XLSX or .PDF format. The ? icon will launch this guided tour.',
		},
		{
			element: '.paged-table',
			intro:
