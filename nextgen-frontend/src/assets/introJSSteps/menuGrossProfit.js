export default function menuGrossProfit() {
	return [
		{
			intro:
				'<center>Welcome to QSROnline’s Menu Gross Profit Report tool! Let us show you around.' +
		...
		},
		{
			...
			intro: '-Select the date, or date range, you wish to display Menu Gross Profit Report',
		},
		{
			element: '.categories-button',
			intro: 'Click to select the Categories for which you want to generate the report.',
		},
		{
			element: '.run-button',
		...
		},
		{
			...
			intro: 'You can export the Menu Gross Profit Report to either .XLSX and .PDF format. The ? icon will launch this guided tour.',
		},
		{
			element: '.paged-table',
			intro:
