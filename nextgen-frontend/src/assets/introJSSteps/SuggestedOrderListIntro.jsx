export default function SuggestedOrderListIntro() {
	return [
		{
			intro:
				'<center>Welcome to QSROnline’s Suggested Order tool! Let us show you around.' +
		...
		},
		{
			...
			intro:
				'Select the Vendor(s) you want to display in the Suggested Order activity list.' +
				'<br> -Only Vendors with previous Suggested Order activity will display data.',
		},
		{
		...
		},
		{
			element: '.add-option',
			intro:
				'The + (plus) sign icon will create a NEW Suggested Order.' +
