export default function laborCICO() {
	return [
		{
			intro:
				'<center>Welcome to QSROnline’s Labor Clock In - Clock Out tool! Let us show you around.' +
		...
		},
		{
			...
			intro: 'You can export the Labor Clock In - Clock Out to either .CSV, .XLSX or .PDF format. The ? icon will launch this guided tour.',
		},
		{
			element: '.paged-table',
			intro:
