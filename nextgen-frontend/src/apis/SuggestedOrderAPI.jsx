...
export const SuggestedOrderAPI = {
  getOrderList: async function (companyID, alignmentID, unitID, memebrID, vendorID, fromDate, toDate  cancel = false) {
    const response = await api.request({
      method: "GET",
      url: `/api/order/GetOrderList?companyId=${companyID}&alignmentId=${alignmentID}&unitId=${unitID}&memberId=${areaID}&fromDate=${fromDate}&toDate=${toDate}`,
