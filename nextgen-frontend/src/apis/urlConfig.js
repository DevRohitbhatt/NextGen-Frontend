const urlConfig = {
	...
	GetActualFoodCostBreakdownIdealReportData: '/api/foodcost/GetActualFoodCostBreakdownIdealReportData',
	GetActualFoodCostBreakdownReportData: '/api/foodcost/GetActualFoodCostBreakdownReportData',
