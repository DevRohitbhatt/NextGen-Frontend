const urlConfig = {
  ...
  GetVarianceFoodCostBreakdownReportData:
    "/api/foodcost/GetVarianceFoodCostBreakdownActualReportData",
  GetVarianceFoodCostBreakdownIdealReportData:
    "/api/foodcost/GetVarianceFoodCostBreakdownIdealReportData",
  SaveCountSheetDesignerComment: "/api/foodcost/SaveCountSheetDesignerComment",
  GetVarianceFoodCostPopupReportData:
    "/api/foodcost/GetVarianceFoodCostPopupReportData",
